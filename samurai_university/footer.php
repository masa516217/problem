<footer class="footer">
  ...
  <!--jQuery-->
  <script src="<?php get_template_directory_uri(); ?>/js/jquery-3.2.1.min.js"></script>
  <script src="<?php get_template_directory_uri(); ?>/styles/bootstrap4/popper.js"></script>
  <script src="<?php get_template_directory_uri(); ?>/styles/bootstrap4/bootstrap.min.js"></script>
